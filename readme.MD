...
####  [原文地址](http://www.ruanyifeng.com/blog/2014/05/oauth_2_0.html)
    ...
    _本人在作者研究的基础上，做了一些勘误和补充说明,这些地方用斜体字表示_
...
<blockquote>
* （1） <strong>Third-party application</strong>：第三方应用程序，本文中又称"客户端"（client），即上一节例子中的"云冲印"。(<i>注：文中多次提到了"客户端"这个名称，这里留意一下，文中所说的客户端是相对于认证服务器而言的，不要简单认为客户端就是浏览器</i>)
